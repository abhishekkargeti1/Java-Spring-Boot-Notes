...
public class PaymentController {
	...
	public ResponseEntity<PaymentDetails> getPaymentDetailsDeleteById(@PathVariable("id") int id){
		 service.getDeletePaymentDetailsById(id);
	...
	public PaymentDetails gteDetailsUpdate(@PathVariable int id, @RequestBody PaymentDetails details) {
			PaymentDetails updateDetails = service.getUpdateDetails(details, id);
